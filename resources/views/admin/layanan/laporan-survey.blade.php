...
@php
    ...
    $items = \App\Models\Dokumen::where('kategori', 'Laporan Survey')
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">Kelola data survey dan arsip laporan survey kepuasan masyarakat.</p>
                    </div>
                </div>

                <div class="flex items-center gap-4">
                    <a href="{{ route('layanan.laporan-survey') }}" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
                        <i class="fas fa-eye mr-3"></i> Lihat Publik
                    </a>
                    <a href="{{ route('admin.dokumen.create', ['kategori' => 'Laporan Survey']) }}" class="px-8 py-4 bg-[#ffc107] text-[#004a99] font-black text-xs uppercase tracking-[3px] rounded-2xl shadow-xl shadow-amber-500/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center border-none cursor-pointer">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Silahkan tambahkan laporan survey pertama Anda</p>
                                    <a href="{{ route('admin.dokumen.create', ['kategori' => 'Laporan Survey']) }}" class="mt-6 px-6 py-2 bg-[#004a99] text-white font-bold rounded-xl text-xs uppercase tracking-widest">Tambah Data</a>
                                </div>
                            </td>
                        </tr>
                        @endforelse
