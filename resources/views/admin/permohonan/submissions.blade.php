        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                ...
                <div class="flex flex-col gap-2 w-full md:w-48">
                    ...
                    <a href="{{ route('admin.permohonan.export.word_register', request()->all()) }}" class="w-full px-4 py-3 bg-blue-600 border border-blue-500 text-white font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-blue-700 transition-all flex items-center justify-center">
