                ...
                <div class="bg-white rounded-2xl shadow-xl border-2 border-slate-100 p-10">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="p-8 bg-blue-50 border-2 border-blue-100 rounded-[2rem] flex items-center justify-between">
                            ...
                            <a href="{{ asset('storage/halaman/'.$settings['layanan_survey_file_laporan']) }}" target="_blank" class="px-6 py-4 bg-[#004a99] text-white font-black text-sm rounded-xl shadow-lg border-none hover:bg-black transition-all cursor-pointer">UNDUH FILE</a>
                        </div>
                        @endif
                    </div>
                </div>
