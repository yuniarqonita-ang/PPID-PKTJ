...
<div class="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-purple-100 p-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-500 mt-1">Kelola laporan layanan informasi publik yang tersedia</p>
        </div>
            ...
            <div class="mb-12 space-y-8 bg-white p-8 rounded-2xl border-2 border-blue-100 shadow-sm">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500">Sesuaikan tampilan awal halaman Laporan Layanan di publik</p>
                    </div>
                </div>
                        ...
                        <div class="group">
                            ...
                            @if(isset($settings['laporan_layanan_file_laporan']) && $settings['laporan_layanan_file_laporan'])
                                <div class="mt-3">
                                    ...
                                    <a href="{{ asset('storage/halaman/' . $settings['laporan_layanan_file_laporan']) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-slate-100 border border-slate-200 rounded-lg text-slate-700 hover:bg-slate-200 transition">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 p-6 shadow-lg">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-bold text-blue-800">Tentang Laporan Layanan</h3>
                            </div>
