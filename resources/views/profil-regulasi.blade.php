...
<head>
    ...
    <title>{{ $profil->judul ?? 'Regulasi PPID' }} - Portal PPID PKTJ</title>
...
<body>
    ...
    <div class="hero-section">
        <div class="hero-content">
            <div class="container">
                <h1 class="display-5 fw-bold mb-3">{{ $profil->judul ?? 'Regulasi PPID' }}</h1>
    ...
    <div class="container py-5">
        <h1 class="page-title">{{ $profil->judul ?? 'Regulasi PPID' }}</h1>
        ...
        @if(!$profil || (!$profil->konten_pembuka && !$profil->gambaran && !$profil->konten_detail))
            <div class="content-box text-center py-4">
                <i class="fas fa-file-contract" style="font-size:40px; color:#6c757d; margin-bottom:15px; display:block;"></i>
