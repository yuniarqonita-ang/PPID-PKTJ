...
<body>
    ...
    <div class="hero-section">
        <div class="container hero-content">
            <h1 class="display-4 fw-bold outfit uppercase mb-2">{{ $settings['sop_pemutakhiran_judul_hero'] ?? 'SOP Pemutakhiran' }}</h1>
            <p class="lead opacity-75">{{ $settings['sop_pemutakhiran_tagline_hero'] ?? 'Standar Operasional Prosedur Pengelolaan Daftar Informasi' }}</p>
        </div>
    </div>
