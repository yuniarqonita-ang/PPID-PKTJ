            ...
            <ul class="navbar-nav me-auto align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" style="min-width: 320px;">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('layanan.laporan-layanan')); ?>">Laporan Layanan Informasi Publik</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('layanan.laporan-akses')); ?>">Laporan Akses Informasi Publik</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('layanan.laporan-survey')); ?>">Laporan Survey Kepuasan Layanan Informasi Publik</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" style="min-width: 380px;">
                        <li><a class="dropdown-item" href="<?php echo e(route('prosedur.sop-permintaan')); ?>">SOP Permintaan Informasi Publik</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('prosedur.sop-keberatan')); ?>">SOP Penanganan Keberatan</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('prosedur.sop-sengketa')); ?>">SOP Pengajuan Sengketa Informasi Publik</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('prosedur.sop-pemutakhiran')); ?>">SOP Penetapan dan Pemutakhiran Daftar Informasi Publik</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('prosedur.sop-pengujian')); ?>">SOP Pengujian Konsekuensi</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('prosedur.sop-pendokumentasian')); ?>">SOP Pendokumentasian Informasi Publik</a></li>
                    </ul>
                </li>
