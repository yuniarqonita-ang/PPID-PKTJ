...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="info-box">
            ...
            <p><strong>Definisi:</strong> Informasi Serta Merta adalah informasi yang disampaikan oleh PPID secara tiba-tiba kepada publik karena situasi tertentu yang mendesak dan sangat mempengaruhi kepentingan publik.</p>
        </div>
        ...
        <div class="content-box">
            ...
            <?php else: ?>
                <div class="no-data">
                    ...
                    <p>Belum ada Informasi Serta Merta yang tersedia.</p>
                </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\laragon\www\PPID-PKTJ\resources\views/informasi-serta-merta.blade.php ENDPATH**/ ?>