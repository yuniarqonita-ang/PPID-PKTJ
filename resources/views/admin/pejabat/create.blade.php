    ...
    <form action="{{ route('admin.pejabat.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-[2.5rem] p-10 shadow-xl border-2 border-slate-100 space-y-8">
        ...
        <div class="bg-amber-50/60 p-8 rounded-3xl border-2 border-amber-100 space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div id="lhkpnCreateContainer" class="space-y-3">
                    <div class="lhkpn-link-row p-4 bg-white rounded-2xl border-2 border-amber-200 shadow-sm flex flex-col md:flex-row gap-3 items-start md:items-center">
                        ...
                        <div class="pt-2 md:pt-5">
                            <button type="button" onclick="removeCreateLhkpnRow(this)" class="px-3 py-2.5 bg-rose-50 text-rose-600 hover:bg-rose-100 rounded-xl text-xs font-bold transition-all" title="Hapus baris ini">
                ...
                <button type="button" onclick="addCreateLhkpnRow()" class="px-4 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-xs font-bold transition-all inline-flex items-center gap-2 shadow-sm">
            ...
            <script>
                function addCreateLhkpnRow() {
                    const container = document.getElementById('lhkpnCreateContainer');
                ...
                function removeCreateLhkpnRow(btn) {
                    const container = document.getElementById('lhkpnCreateContainer');
