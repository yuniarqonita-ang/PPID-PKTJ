...
<div class="min-h-screen bg-gradient-to-br from-slate-200 via-orange-100 to-amber-200 p-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-800 mt-1 font-medium">Kelola SOP penetapan dan pemutakhiran daftar informasi publik yang tersedia</p>
        </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            @if(isset($settings['sop_penetapan_gambar_sop']) && $settings['sop_penetapan_gambar_sop'])
                                <div class="mt-4">
                                    <div class="relative rounded-xl overflow-hidden border-2 border-orange-400 shadow-xl">
                                        <img src="{{ asset('storage/halaman/' . $settings['sop_penetapan_gambar_sop']) }}" alt="Gambar SOP saat ini" class="w-full h-auto">
                                    </div>
                    ...
                    <div class="space-y-6 pt-8 border-t-2 border-orange-300">
                        ...
                        <div class="group">
                            ...
                            @if(isset($settings['sop_penetapan_gambar_proses']) && $settings['sop_penetapan_gambar_proses'])
                                <div class="mt-4">
                                    <div class="relative rounded-xl overflow-hidden border-2 border-amber-400 shadow-xl">
                                        <img src="{{ asset('storage/halaman/' . $settings['sop_penetapan_gambar_proses']) }}" alt="Gambar Proses saat ini" class="w-full h-auto">
                                    </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 border-2 border-blue-400 p-6 shadow-xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-bold text-blue-900">Tentang SOP Penetapan</h3>
                            </div>
                            <p class="text-sm text-blue-800 leading-relaxed">
                                SOP Penetapan dan Pemutakhiran adalah standar operasional prosedur yang mengatur tata cara penetapan dan pemutakhiran daftar informasi publik sesuai peraturan perundang-undangan yang berlaku.
                            </p>
                        </div>
                    </div>
