...
<head>
    ...
    <title>{{ $settings['sop_sengketa_judul_hero'] ?? 'Prosedur Pengajuan Sengketa' }} - {{ $settings['ppid_nama'] ?? 'Portal PPID PKTJ' }}</title>
...
<body>
    ...
    <div class="hero-section">
        <div class="container hero-content text-center">
            ...
            <h1 class="hero-title outfit">{{ $settings['sop_sengketa_judul_hero'] ?? 'Prosedur Pengajuan Sengketa' }}</h1>
    ...
    {{-- ============================================================ --}}
    @include('components.sop-diagram-roadmap', ['pKey' => 'sop_seng'])
