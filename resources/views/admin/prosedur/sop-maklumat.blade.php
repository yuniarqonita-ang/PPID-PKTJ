            ...
            <div class="space-y-6">
                ...
                <div>
                    <h1 class="text-3xl md:text-5xl font-black tracking-tight leading-tight text-white mb-2">
                        SOP <span class="text-[#ffc107]">Maklumat Pelayanan</span>
                    </h1>
                    <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">SOP Standar Maklumat Pelayanan Publik.</p>
                </div>
            </div>

            <div class="flex items-center gap-4">
                <a href="{{ route('prosedur.sop-maklumat') }}" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
            ...
            <div class="p-10 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        ...
                        <input type="text" name="judul_hero" value="{{ $settings[$prefix . '_judul_hero'] ?? 'SOP Maklumat Pelayanan' }}"
