...
<div class="space-y-8 animate-fade-in lg:px-8">
    ...
    <div class="bg-gradient-to-br from-[#004a99] via-[#005bb5] to-[#006ccf] rounded-[2rem] p-10 md:p-12 shadow-xl text-white relative overflow-hidden mb-10">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            ...
            <div class="flex items-center gap-4">
                <a href="http://ppid.pktj.ac.id/prosedur/sop-penetapan-dan-pemutakhiran-dip" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
    ...
    <form id="sop-form" action="{{ route('admin.halaman-custom.store', 'sop_penetapan') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
        @csrf
            ...
            <div class="p-10 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        ...
                        <input type="text" name="judul_hero" value="{{ $settings['sop_penetapan_judul_hero'] ?? 'SOP Penetapan dan Pemutakhiran DIP' }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-xl border-2 border-slate-100 p-10">
                ...
                <div class="space-y-4">
                    ...
                    <textarea name="konten" class="tinymce-editor">{{ $settings['sop_penetapan_konten'] ?? '' }}</textarea>
