...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">{{ $agenda->judul }}</h1>
        ...
        <div class="flex justify-end mt-6">
            <a href="{{ route('admin.agenda.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 mr-2">Kembali</a>
