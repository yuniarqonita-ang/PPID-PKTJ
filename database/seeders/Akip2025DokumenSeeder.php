    ...
    public function run()
    {
        ...
        $setiapSaatItems = [
            [
                ...
                'deskripsi' => '<p>Daftar klasifikasi resmi seluruh dokumen informasi terbuka dan informasi yang dikecualikan di lingkungan Politeknik Keselamatan Transportasi Jalan Tegal.</p>',
                'tanggal' => date('Y-m-d'),
                'file_path' => 'storage/dokumen/G1.pdf',
                'file_name' => 'DIP_dan_DIK_PKTJ_2025.pdf',
                'file_size' => '211 KB',
                'file_type' => 'pdf',
                'bisa_download' => true,
                'is_blurred' => false,
            ...
            [
                ...
                'deskripsi' => '<p>Kumpulan SOP pelayanan publik: Akademik, Laboratorium Keselamatan Jalan, Asrama, Klinik Kesehatan, Perpustakaan, dan Unit Pengelola Usaha (BLU) PKTJ.</p>',
                'tanggal' => date('Y-m-d'),
                'file_path' => 'storage/dokumen/G2.pdf',
                'file_name' => 'Buku_SOP_Layanan_Publik_PKTJ.pdf',
                'file_size' => '8.6 MB',
                'file_type' => 'pdf',
                'bisa_download' => true,
                'is_blurred' => false,
            ...
            [
                ...
                'deskripsi' => '<p>Rekapitulasi arsip persuratan kedinasan resmi masuk dan keluar di lingkungan Politeknik Keselamatan Transportasi Jalan.</p>',
                'tanggal' => date('Y-m-d'),
                'file_path' => 'storage/dokumen/Surat_Masuk_Keluar.pdf',
                'file_name' => 'Register_Surat_Masuk_Keluar_2023_2025.pdf',
                'file_size' => '7.9 MB',
                'file_type' => 'pdf',
                'bisa_download' => true,
                'is_blurred' => false,
            ...
            [
                ...
                'deskripsi' => '<p>Laporan inventarisasi aset dan perbendaharaan barang milik negara PKTJ yang telah diaudit dan terdaftar di SIMAN Kemenkeu.</p>',
                'tanggal' => date('Y-m-d'),
                'file_path' => 'storage/dokumen/Laporan_BMN.pdf',
                'file_name' => 'Laporan_BMN_PKTJ_2025_Audited.pdf',
                'file_size' => '4.8 MB',
                'file_type' => 'pdf',
                'bisa_download' => true,
                'is_blurred' => false,
