...
<body>
    ...
    <div class="gateway-container">
        ...
        <div class="right-panel">
            ...
            <button type="button" class="btn-auth-secondary" onclick="openGoogleModal()">
    ...
    <!-- GOOGLE SIGN-IN MODAL (POPUP LOGIN CEPAT) -->
    <div id="googleModalOverlay" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.65); z-index: 9999; align-items: center; justify-content: center; backdrop-filter: blur(4px);">
        <div style="background: white; border-radius: 20px; width: 90%; max-width: 440px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); overflow: hidden; animation: zoomIn 0.2s ease;">
            <div style="padding: 22px 26px; border-bottom: 1px solid #f1f5f9; display: flex; align-items: center; justify-content: space-between;">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <span style="font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 16px; color: #1e293b;">Masuk dengan Akun Google</span>
                </div>
                <button type="button" onclick="closeGoogleModal()" style="border: none; background: transparent; font-size: 24px; color: #94a3b8; cursor: pointer; line-height: 1;">&times;</button>
            </div>
            
            <form action="{{ route('auth.google.post') }}" method="POST" style="padding: 24px 26px;">
                @csrf
                <p style="font-size: 13px; color: #64748b; margin-bottom: 18px; line-height: 1.5;">
                    Gunakan akun Google / Gmail aktif Anda untuk masuk langsung dan mengajukan permohonan informasi publik.
                </p>

                <div style="margin-bottom: 14px;">
                    <label style="display: block; font-size: 12px; font-weight: 700; color: #334155; margin-bottom: 6px;">Nama Pemilik Akun <span style="color:#ef4444;">*</span></label>
                    <input type="text" name="google_name" required placeholder="Nama lengkap Anda" style="width: 100%; border: 1.5px solid #cbd5e1; border-radius: 10px; padding: 10px 14px; font-size: 13.5px; outline: none;" value="{{ old('google_name') }}">
                </div>

                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-size: 12px; font-weight: 700; color: #334155; margin-bottom: 6px;">Alamat Email Google (@gmail.com) <span style="color:#ef4444;">*</span></label>
                    <input type="email" name="google_email" required placeholder="email.anda@gmail.com" style="width: 100%; border: 1.5px solid #cbd5e1; border-radius: 10px; padding: 10px 14px; font-size: 13.5px; outline: none;" value="{{ old('google_email') }}">
                </div>

                <div style="display: flex; gap: 10px;">
                    <button type="button" onclick="closeGoogleModal()" style="flex: 1; border: 1.5px solid #e2e8f0; background: #f8fafc; color: #475569; border-radius: 10px; padding: 10px; font-size: 13px; font-weight: 600; cursor: pointer;">
                        Batal
                    </button>
                    <button type="submit" style="flex: 2; border: none; background: #1d4ed8; color: white; border-radius: 10px; padding: 10px; font-size: 13.5px; font-weight: 700; cursor: pointer; box-shadow: 0 4px 12px rgba(29, 78, 216, 0.25);">
                        Masuk Sekarang ➔
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        function openGoogleModal() {
            document.getElementById('googleModalOverlay').style.display = 'flex';
        }

        function closeGoogleModal() {
            document.getElementById('googleModalOverlay').style.display = 'none';
        }
