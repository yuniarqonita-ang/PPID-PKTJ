        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative group">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
                    <h1 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-lg">🏢 Edit Struktur Organisasi PPID</h1>
                </div>
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('admin.struktur.update', 1) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-slate-300 font-bold mb-2">Deskripsi Struktur</label>
                        ...
                        <div>
                            <label class="block text-slate-300 font-bold mb-2">Upload Gambar Struktur Organisasi</label>
                            <input type="file" name="gambar" accept="image/*" class="w-full px-4 py-2 border-2 border-slate-600 bg-slate-900/50 text-white placeholder-slate-500 rounded-lg">
                        </div>
