...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <h1 class="display-4 fw-bold uppercase">Informasi Dikecualikan</h1>
            <p class="lead opacity-75">Informasi yang tidak dapat dibuka untuk umum berdasarkan pengujian konsekuensi</p>
        </div>
    </div>

    <div class="container py-5 mb-5">
        <div class="content-box">
            <h2 class="section-title">Daftar Informasi Dikecualikan</h2>
            <p class="text-muted mb-5">Berikut adalah daftar informasi yang dikategorikan sebagai rahasia/dikecualikan sesuai peraturan perundang-undangan.</p>
