...
<body>
    ...
    <div class="hero-section">
        <div class="container hero-content">
            <h1 class="display-4 fw-bold outfit uppercase mb-3">{{ !empty($profil->judul) ? $profil->judul : 'Visi & Misi' }}</h1>
    ...
    <div class="container mb-5">
        <div class="content-card" data-aos="fade-up" data-aos-delay="100">
            @if($profil && ($profil->konten_pembuka || $profil->konten_detail || $profil->judul_sub || $profil->additional_sections || $profil->gambaran))
            ...
            @else
                <div class="text-center py-5">
                    <i class="fas fa-bullseye fa-4x text-muted mb-4 opacity-50"></i>
                    <h3 class="text-muted fw-bold">Konten Sedang Disiapkan</h3>
                    <p class="text-muted">Informasi Visi &amp; Misi PPID PKTJ dapat disesuaikan melalui Admin Panel.</p>
                </div>
            @endif
        </div>
    </div>
