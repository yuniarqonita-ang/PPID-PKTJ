        ...
        <div class="flex min-h-screen">
            <div class="w-80 bg-slate-900 text-white hidden md:block shadow-xl sticky top-0 h-screen flex flex-col">
                ...
                <nav class="flex-1 overflow-y-auto sidebar-scroll px-4 py-4">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center py-2 px-4 rounded-lg hover:bg-slate-800 mb-6 <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-600' : ''); ?>">
                    ...
                    <div class="space-y-1 mb-6">
                        <?php $__currentLoopData = ['edit' => 'Profil PPID', 'tugas' => 'Tugas & Fungsi', 'visi' => 'Visi & Misi', 'struktur' => 'Struktur Organisasi', 'regulasi' => 'Regulasi PPID', 'kontak' => 'Kontak']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.profil.'.$key)); ?>" class="block py-1.5 px-6 text-xs text-slate-400 hover:text-white hover:bg-slate-800 rounded">• <?php echo e($label); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

                    <div class="text-[11px] font-bold text-blue-500 uppercase px-4 mb-2 tracking-widest">2. Informasi Publik</div>
                    <div class="space-y-1 mb-6">
                        <?php $__currentLoopData = ['berkala' => 'Informasi Berkala', 'sertamerta' => 'Informasi Serta Merta', 'setiapsaat' => 'Informasi Setiap Saat', 'dikecualikan' => 'Informasi Dikecualikan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.informasi.'.$key)); ?>" class="block py-1.5 px-6 text-xs text-slate-400 hover:text-white hover:bg-slate-800 rounded">• <?php echo e($label); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="space-y-1 mb-6 text-xs text-slate-400">
                        <a href="<?php echo e(route('admin.prosedur.index')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded font-bold text-blue-300">⚙️ KELOLA SEMUA SOP</a>
                    ...
                    <div class="space-y-1 mb-6 text-xs text-slate-400">
                        <a href="<?php echo e(route('admin.lpse.index')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded">• Pengadaan Barang & Jasa</a>
                        <a href="<?php echo e(route('admin.jdih.index')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded">• JDIH Kemenhub</a>
                    </div>
                    ...
                    <div class="space-y-1 mb-10 text-xs text-slate-400">
                        <a href="<?php echo e(route('admin.berita.index')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded">📰 Berita Terkini</a>
                        <a href="<?php echo e(route('admin.dokumen.index')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded">📁 File Dokumen</a>
                        <a href="<?php echo e(route('admin.faq.index')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded">❓ FAQ</a>
                        <a href="<?php echo e(route('admin.users')); ?>" class="block py-1.5 px-6 hover:text-white hover:bg-slate-800 rounded">👥 User Management</a>
                    </div>
                </nav>
            </div>
