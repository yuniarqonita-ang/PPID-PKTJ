...
class ProfilPublikController extends Controller
{
    ...
    public function showProfil()
    {
        ...
        if ($profil && (!str_contains($profil->konten_pembuka ?? '', 'KP-PKTJ 384') || str_contains($profil->konten_pembuka ?? '', 'Bali') || str_contains($profil->konten_pembuka ?? '', 'Trans Jaya') || strlen($profil->konten_pembuka ?? '') > 2500)) {
