...
<body>
    ...
    <div class="container">
        <div class="content-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-lg-8">
                        <div class="position-relative">
                            ...
                            <input type="text" id="topSearchInputSetiapSaat" placeholder="Cari dokumen, pedoman, standar, atau informasi setiap saat..." onkeyup="filterSetiapSaat()" class="form-control form-control-lg ps-5 rounded-pill border-2 bg-white" style="font-size: 14.5px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                        </div>
                    </div>
                    <div class="col-lg-4 text-lg-end text-muted small">
                        <span class="badge bg-white text-dark border px-3 py-2 rounded-pill shadow-xs">
                            <i class="fas fa-clock text-primary me-1"></i> Akses Informasi Setiap Saat
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4" id="setiapSaatItemsContainer">
                @forelse($items as $item)
                    <div class="col-12 searchable-setiapsaat-item" data-keywords="{{ strtolower($item->judul . ' ' . strip_tags($item->deskripsi)) }}">
    ...
    <script>
        ...
        function filterSetiapSaat() {
            const query = document.getElementById('topSearchInputSetiapSaat').value.toLowerCase().trim();
            document.querySelectorAll('.searchable-setiapsaat-item').forEach(el => {
