...
<div class="space-y-8 animate-fade-in lg:px-8">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div class="space-y-4">
                ...
                <h1 class="text-3xl md:text-5xl font-black tracking-tight leading-tight text-white mb-2">
                    Prosedur <span class="text-[#ffc107]">Penanganan Keberatan</span>
                </h1>
    ...
    @include('admin.components.sop-settings-form', [
        'prefix' => 'sop_keberatan',
        'judulSop' => 'Prosedur Penanganan Keberatan',
        'publicRoute' => route('prosedur.sop-keberatan')
    ])
</div>
@endsection
