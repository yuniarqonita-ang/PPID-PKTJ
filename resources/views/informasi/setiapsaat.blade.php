    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold text-info">📄 Informasi Setiap Saat</h2>
                    <p class="text-muted">Informasi yang harus tersedia setiap saat</p>
                </div>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted">Belum Ada Informasi Setiap Saat</h4>
                    <p class="text-muted">Informasi setiap saat akan segera tersedia</p>
                </div>
            @endif
        </div>
    </div>
