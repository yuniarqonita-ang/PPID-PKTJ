        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-black text-[#004a99] uppercase tracking-tight">
                    <i class="fas fa-lock mr-2 text-[#ffc107]"></i> Informasi Dikecualikan
                </h1>
                <p class="text-gray-500 font-medium mt-1">Daftar informasi yang dikecualikan berdasarkan uji konsekuensi</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="http://ppid.pktj.ac.id/informasi-publik/dikecualikan" target="_blank" class="px-6 py-3 bg-white border border-gray-200 text-[#004a99] font-bold rounded-xl shadow-sm hover:bg-gray-50 transition-all flex items-center">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Silahkan tambahkan informasi dikecualikan pertama Anda</p>
                                    <a href="{{ route('admin.informasi.dikecualikan.create') }}" class="mt-6 px-6 py-2 bg-[#004a99] text-white font-bold rounded-xl text-xs uppercase tracking-widest">Tambah Data</a>
                                </div>
                            </td>
                        </tr>
                        @endforelse
