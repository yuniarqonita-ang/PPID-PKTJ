...
<div class="min-h-screen bg-gradient-to-br from-slate-200 via-orange-100 to-amber-200 p-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-800 mt-1 font-medium">Kelola SOP penanganan keberatan yang tersedia</p>
        </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 border-2 border-blue-400 p-6 shadow-xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-bold text-blue-900">Tentang SOP Penanganan</h3>
                            </div>
                            <p class="text-sm text-blue-800 leading-relaxed">
                                SOP Penanganan Keberatan adalah standar operasional prosedur yang mengatur tata cara penanganan keberatan atas permohonan informasi publik sesuai peraturan perundang-undangan yang berlaku.
                            </p>
                        </div>
                    </div>
