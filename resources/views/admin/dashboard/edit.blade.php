...
<div class="min-h-screen bg-gray-50 p-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">🎨 Edit Dashboard Publik</h1>
            <p class="text-gray-600 mt-1">Sesuaikan tampilan halaman publik PPID PKTJ</p>
        </div>
        ...
        <form action="{{ route('dashboard.update') }}" method="POST">
            ...
            <div class="p-6 space-y-8">
                ...
                <div class="pb-8">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">E-PPID Kemenhub</label>
                                <input type="url" 
                                       name="app_eppid" 
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">LPSE PKTJ</label>
                                <input type="url" 
                                       name="app_lpse" 
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">JDIH PKTJ</label>
                                <input type="url" 
                                       name="app_jdih" 
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Sistem Informasi PKTJ</label>
                                <input type="url" 
                                       name="app_sistem" 
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Nama PPID</label>
                            <input type="text" 
                                   name="ppid_nama" 
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Deskripsi PPID</label>
            ...
            <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-4">
                <a href="{{ route('dashboard') }}" class="px-6 py-2 text-gray-700 hover:text-gray-900 font-medium">
                    Batal
                </a>
