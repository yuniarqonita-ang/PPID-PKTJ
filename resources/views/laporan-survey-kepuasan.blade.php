...
<body>
    ...
    <div class="hero-section">
        <div class="container text-center">
            <h1 class="display-5 fw-bold uppercase">Laporan Survey Kepuasan</h1>
            <p class="lead opacity-75">Hasil Indeks Kepuasan Masyarakat terhadap Pelayanan Informasi Publik.</p>
        </div>
    </div>

    <div class="container py-5 mb-5">
        <div class="content-box">
            <h2 class="fw-bold mb-1" style="font-size: 2.2rem; color: #1e293b;">Laporan Kepuasan Pelayanan Informasi Publik</h2>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <i class="fas fa-poll d-block mb-3 opacity-25" style="font-size: 3rem;"></i>
                                    Belum ada data laporan survey tersedia.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
