...
<body>
    ...
    <div class="container py-5">
        <div class="faq-container">
            ...
            <p class="faq-subtitle">Showing 1-<?php echo e(count($faqs)); ?> of <?php echo e(count($faqs)); ?> items.</p>
                ...
                <div class="table-responsive">
                    <table class="faq-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="no-column"><?php echo e($faq->id); ?></td>
                                <td class="pertanyaan-column"><?php echo e($faq->pertanyaan); ?></td>
                                <td class="jawaban-column"><?php echo e($faq->jawaban); ?></td>
                            </tr>
