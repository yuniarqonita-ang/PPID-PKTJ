...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-400 mt-1">Kelola informasi yang harus segera disampaikan</p>
        </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="judul" id="judul" 
                               ...
                               placeholder="Contoh: Informasi Penutupan Jalan Darurat" required>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="6"
                                  ...
                                  placeholder="Penjelasan singkat tentang informasi darurat ini"></textarea>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl ring-1 ring-white/10 relative overflow-hidden">
                            <textarea id="editor_sertamerta_index" name="konten" class="w-full p-6 border-0 outline-none resize-none bg-slate-900/60 border-slate-600/50 text-white placeholder-slate-400 shadow-inner focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-400" style="min-height: 300px;">
Tulis konten lengkap informasi serta merta di sini...
                            </textarea>
                        </div>
                    ...
                    <div class="group">
                        ...
                        <input type="datetime-local" name="tanggal" id="tanggal" 
                               class="w-full px-6 py-4 text-lg border-2 border-slate-500/50 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl ring-1 ring-white/10 relative overflow-hidden shadow-sm"
                               required>
                    </div>

                    <!-- Tingkat Kesegeraan Section -->
                    <div class="group">
                        <label class="block text-lg font-bold text-slate-200 mb-3 flex items-center">
                            <span class="w-8 h-8 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white flex items-center justify-center mr-3">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <label class="relative cursor-pointer">
                                <input type="radio" name="tingkat" value="normal" class="peer sr-only" required>
                                <div class="p-4 border-2 border-slate-600/30 rounded-xl hover:border-blue-400 peer-checked:border-blue-500 peer-checked:bg-blue-900/30 transition-all">
                                    <div class="text-center">
                                        <i class="fas fa-clock text-2xl text-slate-400 peer-checked:text-blue-500 mb-2"></i>
                                        <p class="font-medium text-slate-200 peer-checked:text-blue-300">Normal</p>
                                        <p class="text-xs text-slate-400">1-24 jam</p>
                                    </div>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                <input type="radio" name="tingkat" value="segera" class="peer sr-only">
                                <div class="p-4 border-2 border-slate-600/30 rounded-xl hover:border-purple-400 peer-checked:border-purple-500 peer-checked:bg-purple-900/30 transition-all">
                                    <div class="text-center">
                                        <i class="fas fa-exclamation text-2xl text-slate-400 peer-checked:text-purple-500 mb-2"></i>
                                        <p class="font-medium text-slate-200 peer-checked:text-purple-300">Segera</p>
                                        <p class="text-xs text-slate-400">1-6 jam</p>
                                    </div>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                <input type="radio" name="tingkat" value="darurat" class="peer sr-only">
                                <div class="p-4 border-2 border-slate-600/30 rounded-xl hover:border-indigo-400 peer-checked:border-indigo-500 peer-checked:bg-indigo-900/30 transition-all">
                                    <div class="text-center">
                                        <i class="fas fa-bolt text-2xl text-slate-400 peer-checked:text-indigo-600 mb-2"></i>
                                        <p class="font-medium text-slate-200 peer-checked:text-indigo-300">Darurat</p>
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-orange-400">Singkat, jelas, dan mendesak</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <span class="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></span>
                                ...
                                <div class="flex items-start space-x-2">
                                    <span class="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></span>
                                    <div>
                                        <strong class="text-orange-300">Tingkat:</strong>
                                        <p class="text-orange-400">Pilih tingkat kesegeraan</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <span class="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></span>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-900/20 to-indigo-900/20 border border-blue-600/30 p-6 shadow-lg">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-bold text-blue-300">Tentang Informasi Serta Merta</h3>
                            </div>
                            <p class="text-sm text-blue-400 leading-relaxed">
                                Informasi Serta Merta adalah informasi yang harus segera disampaikan kepada masyarakat karena sifatnya yang penting dan mendesak, seperti informasi bencana alam, keadaan darurat, atau pengumuman penting lainnya.
                            </p>
                        </div>
                    </div>
...
<!-- TinyMCE Editor Scripts -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            tinymce.init({
                selector: '#editor_sertamerta_index',
                license_key: 'gpl',
                height: 500,
                menubar: false,
                skin: 'oxide-dark',
