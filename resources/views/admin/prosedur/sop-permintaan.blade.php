...
<div class="min-h-screen bg-gradient-to-br from-slate-200 via-orange-100 to-amber-200 p-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-800 mt-1 font-medium">Kelola SOP permintaan informasi publik yang tersedia</p>
        </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-6 pt-8 border-t-2 border-orange-300">
                        <div class="flex items-center space-x-3 mb-6">
                            ...
                            <h2 class="text-2xl font-bold text-slate-900">Video Tutorial</h2>
                        </div>
                            ...
                            <div class="space-y-3 text-sm">
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-orange-800">Masukkan link YouTube</p>
                                    </div>
                                </div>
                            </div>
                        </div>
