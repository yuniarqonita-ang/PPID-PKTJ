...
<body>
    ...
    <div class="container py-5">
        <h1 class="page-title"><?php echo e($profil->judul ?? 'Kontak PPID'); ?></h1>
        <div class="content-box">
            <?php if($profil): ?>
                ...
                <?php if($profil->konten_detail): ?>
                    <div><?php echo $profil->konten_detail; ?></div>
                <?php endif; ?>
            <?php else: ?>
...
</html><?php /**PATH C:\laragon\www\PPID-PKTJ\resources\views/profil-kontak.blade.php ENDPATH**/ ?>