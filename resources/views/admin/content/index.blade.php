...
<div class="min-h-screen bg-gray-50 p-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">📂 Kelola Konten Publik</h1>
            <p class="text-gray-600 mt-1">Lihat dan kelola semua konten yang ditampilkan di halaman publik</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Informasi Berkala</h3>
                        <p class="text-sm text-gray-500">{{ App\Models\InformasiBerkala::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($berkala as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <div class="flex items-center space-x-1">
                            <a href="{{ route('admin.informasi-berkala.edit', $item->id) }}" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-edit text-sm"></i>
                            </a>
                            <button onclick="confirmDelete('informasi-berkala', {{ $item->id }})" class="text-red-600 hover:text-red-800">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Informasi Serta Merta</h3>
                        <p class="text-sm text-gray-500">{{ App\Models\InformasiSertamerta::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($sertamerta as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <div class="flex items-center space-x-1">
                            ...
                            <button onclick="confirmDelete('informasi-sertamerta', {{ $item->id }})" class="text-red-600 hover:text-red-800">
                                <i class="fas fa-trash text-sm"></i>
                            </button>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Informasi Setiap Saat</h3>
                        <p class="text-sm text-gray-500">{{ App\Models\InformasiSetiapsaat::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($setiapsaat as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <div class="flex items-center space-x-1">
                            ...
                            <button onclick="confirmDelete('informasi-setiapsaat', {{ $item->id }})" class="text-red-600 hover:text-red-800">
                                <i class="fas fa-trash text-sm"></i>
                            </button>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Informasi Dikecualikan</h3>
                        <p class="text-sm text-gray-500">{{ App\Models\InformasiDikecualikan::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($dikecualikan as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <div class="flex items-center space-x-1">
                            ...
                            <button onclick="confirmDelete('informasi-dikecualikan', {{ $item->id }})" class="text-red-600 hover:text-red-800">
                                <i class="fas fa-trash text-sm"></i>
                            </button>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ App\Models\Prosedur::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($prosedur as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        ...
                        <div class="flex items-center space-x-1">
                            ...
                            <button onclick="confirmDelete('prosedur', {{ $item->id }})" class="text-red-600 hover:text-red-800">
                                <i class="fas fa-trash text-sm"></i>
                            </button>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ App\Models\Profil::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($profil as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900 truncate">{{ $item->judul }}</p>
                            <p class="text-xs text-gray-500">{{ $item->tipe }}</p>
                        </div>
                        <div class="flex items-center space-x-1">
                            <a href="{{ route('admin.profil.edit', $item->tipe) }}" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-edit text-sm"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ App\Models\Faq::count() }} item</p>
                    </div>
                </div>
            </div>
            <div class="space-y-2">
                ...
                @forelse($faq as $item)
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900 truncate">{{ $item->pertanyaan }}</p>
                            <p class="text-xs text-gray-500">{{ Str::limit($item->jawaban, 50) }}</p>
                        </div>
                        <div class="flex items-center space-x-1">
                            <a href="{{ route('admin.faq.edit', $item->id) }}" class="text-blue-600 hover:text-blue-800">
                                <i class="fas fa-edit text-sm"></i>
                            </a>
                            <button onclick="confirmDelete('faq', {{ $item->id }})" class="text-red-600 hover:text-red-800">
                                <i class="fas fa-trash text-sm"></i>
                            </button>
                        </div>
                    </div>
