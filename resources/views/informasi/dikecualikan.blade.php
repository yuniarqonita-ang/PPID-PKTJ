        ...
        <div class="col-12">
                            ...
                            <div class="card h-100 shadow-sm hover:shadow-lg transition-shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        ...
                                        <a href="{{ route('download.file', ['model' => 'dikecualikan', 'id' => $item->id]) }}" 
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted">Belum Ada Informasi Dikecualikan</h4>
                    <p class="text-muted">Informasi dikecualikan akan ditampilkan jika tersedia</p>
                </div>
            @endif
        </div>
    </div>
