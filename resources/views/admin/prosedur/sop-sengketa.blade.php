    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h1 class="text-4xl font-black text-[#002b5c] tracking-tight">
                SOP <span class="text-[#004a99]">Penyelesaian Sengketa</span>
            </h1>
            <p class="text-slate-700 text-lg font-bold mt-2">Prosedur Mediasi & Sidang Sengketa Informasi Publik</p>
        </div>
        <div class="flex items-center gap-4">
            ...
            <a href="http://ppid.pktj.ac.id/prosedur/sop-pengajuan-sengketa" target="_blank" class="px-6 py-4 bg-white border-2 border-slate-200 text-[#002b5c] font-black rounded-xl shadow-md hover:bg-slate-50 transition-all flex items-center text-sm">
