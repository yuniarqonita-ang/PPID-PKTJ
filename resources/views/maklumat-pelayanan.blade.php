...
<body>
    ...
    <div class="container page-container">
        <div class="content-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white p-3.5 rounded-3 border h-100 d-flex flex-column justify-content-center">
                            ...
                            <p class="text-muted small mb-3">Kampus II PKTJ Margadana, Jl. Abdul Syukur No. 17, Margadana, Kota Tegal, Jawa Tengah 52143.</p>
            ...
            <!-- DOKUMEN RESMI PERNYATAAN KEBIJAKAN & MAKLUMAT PELAYANAN PKTJ (SUMBER: PKTJ.AC.ID) -->
            <div class="mb-5 pt-2">
                <div class="d-flex align-items-center justify-content-between mb-4 pb-2 border-bottom flex-wrap gap-2">
                    <div>
                        <h3 class="fw-bold outfit text-[#002b5c] mb-1">
                            <i class="fas fa-file-contract text-primary me-2"></i>Pernyataan Kebijakan & Maklumat Pelayanan Resmi PKTJ
                        </h3>
                        <p class="text-muted small mb-0">
                            Dokumen otentik dari portal utama Politeknik Keselamatan Transportasi Jalan (<a href="https://pktj.ac.id/program-studi/50-pernyataan-kebijakan-dan-maklumat-pelayanan-pktj" target="_blank" class="text-decoration-none fw-bold">pktj.ac.id</a>)
                        </p>
                    </div>
                    <a href="https://pktj.ac.id/program-studi/50-pernyataan-kebijakan-dan-maklumat-pelayanan-pktj" target="_blank" class="btn btn-outline-primary btn-sm rounded-pill px-3 py-1.5 fw-bold">
                        <i class="fas fa-external-link-alt me-1"></i> Buka Halaman Asli di pktj.ac.id
                    </a>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="card border-0 rounded-4 shadow-sm h-100 overflow-hidden" style="border: 1px solid #e2e8f0 !important;">
                            <div class="card-header text-white p-3.5 d-flex justify-content-between align-items-center" style="background: #002b5c;">
                                <div>
                                    <div class="badge bg-primary text-white mb-1" style="font-size: 11px;">Kebijakan Resmi</div>
                                    <h5 class="fw-bold outfit text-white mb-0" style="font-size: 15px;">PERNYATAAN KEBIJAKAN PKTJ</h5>
                                </div>
                                <a href="https://drive.google.com/file/d/1ovsgkNLHiRDHKpjT7z6raVWfOY0ZKP7_/view" target="_blank" class="btn btn-warning text-dark btn-sm rounded-pill fw-bold px-3 py-1" style="font-size: 12px;">
                                    <i class="fas fa-external-link-alt me-1"></i> Buka Drive
                                </a>
                            </div>
                            <div class="card-body p-2 bg-light">
                                <div class="ratio ratio-4x3 rounded-3 overflow-hidden shadow-sm border bg-white">
                                    <iframe src="https://drive.google.com/file/d/1ovsgkNLHiRDHKpjT7z6raVWfOY0ZKP7_/preview" style="border:0;" allow="autoplay" loading="lazy"></iframe>
                                </div>
                            </div>
                            <div class="card-footer bg-white p-3 border-top d-flex justify-content-between align-items-center">
                                <small class="text-muted"><i class="fas fa-check-circle text-success me-1"></i> Dokumen Kebijakan Pelayanan Institusi</small>
                                <a href="https://drive.google.com/file/d/1ovsgkNLHiRDHKpjT7z6raVWfOY0ZKP7_/view" target="_blank" class="text-decoration-none fw-bold small text-primary">
                                    Lihat Penuh <i class="fas fa-arrow-right ms-1"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card border-0 rounded-4 shadow-sm h-100 overflow-hidden" style="border: 1px solid #e2e8f0 !important;">
                            <div class="card-header text-white p-3.5 d-flex justify-content-between align-items-center" style="background: #002b5c;">
                                <div>
                                    <div class="badge bg-warning text-dark mb-1" style="font-size: 11px;">Maklumat Layanan</div>
                                    <h5 class="fw-bold outfit text-white mb-0" style="font-size: 15px;">MAKLUMAT PELAYANAN PKTJ</h5>
                                </div>
                                <a href="https://drive.google.com/file/d/1gfbK7_aXxSFC7JVwieR-M39nRXTAZhk7/view" target="_blank" class="btn btn-warning text-dark btn-sm rounded-pill fw-bold px-3 py-1" style="font-size: 12px;">
                                    <i class="fas fa-external-link-alt me-1"></i> Buka Drive
                                </a>
                            </div>
                            <div class="card-body p-2 bg-light">
                                <div class="ratio ratio-4x3 rounded-3 overflow-hidden shadow-sm border bg-white">
                                    <iframe src="https://drive.google.com/file/d/1gfbK7_aXxSFC7JVwieR-M39nRXTAZhk7/preview" style="border:0;" allow="autoplay" loading="lazy"></iframe>
                                </div>
                            </div>
                            <div class="card-footer bg-white p-3 border-top d-flex justify-content-between align-items-center">
                                <small class="text-muted"><i class="fas fa-check-circle text-success me-1"></i> Janji & Komitmen Pelayanan PKTJ</small>
                                <a href="https://drive.google.com/file/d/1gfbK7_aXxSFC7JVwieR-M39nRXTAZhk7/view" target="_blank" class="text-decoration-none fw-bold small text-primary">
                                    Lihat Penuh <i class="fas fa-arrow-right ms-1"></i>
                                </a>
                            </div>
                        </div>
