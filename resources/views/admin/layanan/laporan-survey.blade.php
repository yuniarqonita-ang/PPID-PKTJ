...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-400 mt-1">Kelola laporan survey kepuasan layanan informasi publik yang tersedia</p>
        </div>
            ...
            <div class="mb-12 space-y-8 bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl ring-1 ring-white/10 relative overflow-hidden p-8 rounded-2xl border-2 border-blue-100 shadow-sm">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400">Sesuaikan tampilan awal halaman Laporan Survey di publik</p>
                    </div>
                </div>
                ...
                <div class="group">
                    <label class="block text-sm font-bold text-slate-200 mb-2">Metodologi Survey</label>
                    <textarea id="editor_metodologi" name="metodologi" class="w-full bg-slate-900/60 border-slate-600/50 text-white placeholder-slate-400 shadow-inner focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-400">{{ $settings['laporan_survey_metodologi'] ?? '' }}</textarea>
                </div>
            </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-900/20 to-indigo-900/20 border border-blue-600/30 p-6 shadow-lg">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-bold text-blue-300">Tentang Survey Kepuasan</h3>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editor_ringkasan').summernote({
                height: 300,
                placeholder: 'Tuliskan ringkasan eksekutif laporan survey kepuasan layanan informasi publik secara singkat dan padat...',
                toolbar: [
                    ['style', ['style', 'bold', 'italic', 'underline', 'clear']],
                    ['font', ['strikethrough', 'superscript', 'subscript']],
                    ['fontsize', ['fontsize']],
            ...
            $('#editor_laporan').summernote({
                height: 300,
                placeholder: 'Tuliskan isi laporan survey kepuasan layanan informasi publik secara lengkap dan detail...',
                toolbar: [
                    ['style', ['style', 'bold', 'italic', 'underline', 'clear']],
                    ['font', ['strikethrough', 'superscript', 'subscript']],
                    ['fontsize', ['fontsize']],
