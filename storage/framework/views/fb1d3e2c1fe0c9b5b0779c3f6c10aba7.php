            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card h-100 p-3">
                        ...
                        <a href="<?php echo e(asset('storage/'.$doc->file_path)); ?>" class="btn btn-outline-primary btn-sm mt-auto">Lihat Selengkapnya</a>
                    </div>
                </div>
        ...
        <div class="row pt-4">
            ...
            <div class="col-md-4 mb-5">
                ...
                <div class="list-group card">
                    ...
                    <a href="<?php echo e(route('admin.lpse.index')); ?>" class="list-group-item list-group-item-action py-3">LPSE PKTJ</a>
                    <a href="<?php echo e(route('admin.jdih.index')); ?>" class="list-group-item list-group-item-action py-3">JDIH PKTJ</a>
