...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-200 mt-1 font-medium">Kelola SOP pendokumentasian informasi publik yang tersedia</p>
        </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            @if(isset($settings['sop_pendokumentasian_gambar_sop']) && $settings['sop_pendokumentasian_gambar_sop'])
                                <div class="mt-4">
                                    <div class="relative rounded-xl overflow-hidden border-2 border-orange-400 shadow-xl">
                                        <img src="{{ asset('storage/halaman/' . $settings['sop_pendokumentasian_gambar_sop']) }}" alt="Gambar SOP saat ini" class="w-full h-auto">
                                    </div>
                    ...
                    <div class="space-y-6 pt-8 border-t-2 border-orange-300">
                        ...
                        <div class="group">
                            ...
                            @if(isset($settings['sop_pendokumentasian_gambar_proses']) && $settings['sop_pendokumentasian_gambar_proses'])
                                <div class="mt-4">
                                    <div class="relative rounded-xl overflow-hidden border-2 border-amber-400 shadow-xl">
                                        <img src="{{ asset('storage/halaman/' . $settings['sop_pendokumentasian_gambar_proses']) }}" alt="Gambar Proses saat ini" class="w-full h-auto">
                                    </div>
