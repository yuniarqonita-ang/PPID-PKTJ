        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div class="space-y-6">
                <div class="inline-flex items-center gap-3 px-5 py-2 bg-[#ffc107] rounded-full text-[#004a99]">
                    ...
                    <h2 class="text-[11px] font-black uppercase tracking-[3px]">Sistem Serta Merta: Aktif</h2>
                </div>
                
                <div>
                    <h1 class="text-3xl md:text-5xl font-black tracking-tight leading-tight text-white mb-2">
                        Informasi <span class="text-[#ffc107]">Serta Merta</span>
                    </h1>
                    <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">Dokumen mendadak/krusial yang berhubungan dengan hajat hidup orang banyak.</p>
                </div>
            </div>
