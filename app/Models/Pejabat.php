    ...
    public static function getDefaultPejabatData()
    {
        return [
            ...
            [
                ...
                'riwayat_jabatan' => [
                    'Wakil Direktur I PKTJ (2026 - Sekarang)',
                    'Wakil Direktur III PKTJ (2019 - 2026)',
                    'Dosen / Lektor Kepala PKTJ Tegal'
                ],
                'penghargaan' => [
                    'Satya Lencana Karya Satya 10 Tahun Presiden RI',
                    'Piagam Penghargaan Lulusan Predikat Cumlaude'
                ],
            ...
            [
                ...
                'riwayat_jabatan' => [
                    'Wakil Direktur II PKTJ Tegal (2026 - Sekarang)',
                    'Dosen / Lektor BPSDMP Kemenhub',
                    'Kepala Seksi / Kasubbag Lingkungan Kemenhub'
                ],
                'penghargaan' => [
                    'Satya Lancana Karya Satya Presiden RI'
                ],
                'lhkpn_link' => 'https://elhkpn.kpk.go.id',
                'lhkpn_file' => null,
                'lhkpn_tahun' => '2025/2026',
            ...
            [
                ...
                'pendidikan' => [
                    ...
                    'D4 / Sarjana Terapan Transportasi Darat, STTD'
                ],
                'riwayat_jabatan' => [
                    'Wakil Direktur III PKTJ Tegal (2026 - Sekarang)',
