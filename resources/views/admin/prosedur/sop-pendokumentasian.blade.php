...
<div class="space-y-8 animate-fade-in lg:px-8">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div class="space-y-4">
                ...
                <h1 class="text-3xl md:text-5xl font-black tracking-tight leading-tight text-white mb-2">
                    Prosedur <span class="text-[#ffc107]">Pendokumentasian Informasi</span>
                </h1>
            ...
            <div>
                <a href="{{ route('prosedur.sop-pendokumentasian') }}" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
                    <i class="fas fa-eye mr-3 text-amber-400"></i> Lihat Publik
                </a>
            </div>
        </div>
    </div>
    ...
    @include('admin.components.sop-settings-form', [
        'prefix' => 'sop_pendokumentasian',
        'judulSop' => 'Prosedur Pendokumentasian Informasi Publik',
        'publicRoute' => route('prosedur.sop-pendokumentasian')
    ])
</div>
@endsection
