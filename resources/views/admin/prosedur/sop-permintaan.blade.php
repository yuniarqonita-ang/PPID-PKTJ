...
<div class="space-y-8 animate-fade-in lg:px-8">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div class="space-y-6">
                <div class="inline-flex items-center gap-3 px-5 py-2 bg-[#ffc107] rounded-full text-[#004a99]">
                    ...
                    <h2 class="text-[11px] font-black uppercase tracking-[3px]">Sistem SOP: FK-Aktif</h2>
                </div>
                ...
                <div>
                    ...
                    <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">Kelola dokumen Prosedur Operasional Standar Permintaan Informasi Publik.</p>
                </div>
            </div>
    ...
    @include('admin.components.dokumen-list-admin', ['kategori' => 'SOP Permintaan Informasi Publik'])
</div>
@endsection
