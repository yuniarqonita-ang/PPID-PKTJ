...
<div class="space-y-8 animate-fade-in lg:px-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <h1 class="text-3xl md:text-5xl font-black tracking-tight leading-tight text-white mb-2">
                        SOP <span class="text-[#ffc107]">Penyelesaian Sengketa</span>
                    </h1>
                    <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">Prosedur Mediasi & Sidang Sengketa Informasi Publik.</p>
                </div>
            </div>

            <div class="flex items-center gap-4">
                <a href="http://ppid.pktj.ac.id/prosedur/sop-pengajuan-sengketa" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
    ...
    <form action="{{ route('admin.halaman-custom.store', 'sop_sengketa') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
        @csrf
            ...
            <div class="p-10 space-y-10">
                <div class="flex items-center justify-between border-b-2 border-slate-50 pb-8">
                    <h3 class="text-xl font-black text-[#004a99] uppercase tracking-widest flex items-center">
                        ...
                        Konfigurasi Identitas Prosedur
                    </h3>
                </div>
        ...
        <div class="flex justify-end gap-6 pt-10">
            ...
            <button type="submit" class="px-12 py-4 bg-[#004a99] text-white font-black text-sm rounded-xl shadow-2xl hover:bg-black transition-all tracking-widest border-none cursor-pointer uppercase">
                <i class="fas fa-save mr-3 text-[#ffc107]"></i> SIMPAN PROSEDUR SENGKETA
            </button>
        </div>
    </form>
</div>
