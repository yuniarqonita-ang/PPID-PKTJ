...
<body>
    ...
    <div class="hero-section">
        <div class="hero-content">
            <div class="container">
                <h1 class="display-5 fw-bold mb-3">{{ $settings['laporan_survey_judul_hero'] ?? 'Laporan Survey Kepuasan' }}</h1>
                <p class="lead">{{ $settings['laporan_survey_tagline_hero'] ?? 'Hasil survei kepuasan pemohon informasi publik PPID PKTJ' }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        <h1 class="page-title">{{ $settings['laporan_survey_judul_hero'] ?? 'Laporan Survey Kepuasan Layanan Informasi Publik' }}</h1>
