...
<head>
    ...
    <title>Maklumat Pelayanan & Standar Biaya - Portal PPID PKTJ</title>
...
<body>
    ...
    <div style="background-color: #f8f9fa; padding: 40px 0;">
        <div class="container">
            <h1 style="color: #333; font-size: 32px; font-weight: bold; margin-bottom: 25px;">Maklumat Pelayanan & Standar Biaya Kementerian Perhubungan</h1>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        <tr style="background-color: #f5f5f5; border-bottom: 1px solid #ddd;">
                            ...
                            <td style="padding: 15px;">Maklumat Pelayanan & Standar Biaya Tahun 2025</td>
                        ...
                        <tr style="background-color: white; border-bottom: 1px solid #ddd;">
                            ...
                            <td style="padding: 15px;">Maklumat Pelayanan & Standar Biaya Tahun 2024</td>
                            <td style="padding: 15px; text-align: center;">
                                <a href="#" style="background-color: #ffc107; color: #333; padding: 8px 16px; border-radius: 5px; text-decoration: none; font-weight: 600; display: inline-block; font-size: 13px;">
                                    <i class="fas fa-download" style="margin-right: 6px;"></i>Unduh Dokumen
                                </a>
                        ...
                        <tr style="background-color: #f5f5f5; border-bottom: 1px solid #ddd;">
                            ...
                            <td style="padding: 15px;">Maklumat Pelayanan & Standar Biaya Tahun 2023</td>
                            <td style="padding: 15px; text-align: center;">
                                <a href="#" style="background-color: #ffc107; color: #333; padding: 8px 16px; border-radius: 5px; text-decoration: none; font-weight: 600; display: inline-block; font-size: 13px;">
                                    <i class="fas fa-download" style="margin-right: 6px;"></i>Unduh Dokumen
                                </a>
                        ...
                        <tr style="background-color: white; border-bottom: 1px solid #ddd;">
                            ...
                            <td style="padding: 15px;">Maklumat Pelayanan & Standar Biaya Tahun 2022</td>
                            <td style="padding: 15px; text-align: center;">
                                <a href="#" style="background-color: #ffc107; color: #333; padding: 8px 16px; border-radius: 5px; text-decoration: none; font-weight: 600; display: inline-block; font-size: 13px;">
                                    <i class="fas fa-download" style="margin-right: 6px;"></i>Unduh Dokumen
                                </a>
...
<?php /**PATH C:\laragon\www\PPID-PKTJ\resources\views/maklumat-pelayanan.blade.php ENDPATH**/ ?>