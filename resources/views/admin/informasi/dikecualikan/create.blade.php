                ...
                <div class="p-8 md:p-12 space-y-8">
                    ...
                    <div class="space-y-3 text-gray-800">
                        ...
                        <div class="rounded-3xl overflow-hidden border-2 border-slate-100 text-gray-800">
                            <textarea name="dasar_hukum" id="dasar_hukum_editor" class="tinymce-editor text-gray-800">{{ old('dasar_hukum') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3 text-gray-800">
                            ...
                            <div class="rounded-3xl overflow-hidden border-2 border-slate-100 text-gray-800">
                                <textarea name="konsekuensi_dibuka" id="konsekuensi_dibuka_editor" class="tinymce-editor text-gray-800">{{ old('konsekuensi_dibuka') }}</textarea>
                            </div>
                        </div>
                        <div class="space-y-3 text-gray-800">
                            <label class="text-xs font-black text-red-600 uppercase tracking-[2px] block">Konsekuensi Ditutup Bagi Publik</label>
                            <div class="rounded-3xl overflow-hidden border-2 border-slate-100 text-gray-800">
                                <textarea name="konsekuensi_ditutup" id="konsekuensi_ditutup_editor" class="tinymce-editor text-gray-800">{{ old('konsekuensi_ditutup') }}</textarea>
                            </div>
                        </div>
                    </div>
