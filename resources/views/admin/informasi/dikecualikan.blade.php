...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-400 mt-1">Kelola informasi yang dikecualikan sesuai peraturan</p>
        </div>
    ...
    <div class="bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl ring-1 ring-white/10 relative overflow-hidden shadow-lg p-8">
        <div class="text-center py-12">
            ...
            <h2 class="text-2xl font-bold text-slate-200 mb-4">Belum Ada Informasi Dikecualikan</h2>
            <p class="text-slate-300 mb-6">Belum ada informasi yang dikecualikan saat ini.</p>
