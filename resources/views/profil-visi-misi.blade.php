...
<head>
    ...
    <title>{{ $profil->judul ?? 'Visi dan Misi PPID' }} - Portal PPID PKTJ</title>
    ...
    <style>
        ...
        .profil-content { text-align: justify; line-height: 1.8; color: #333; }
        .footer { background: #1a3a52; color: white; padding: 40px 0; margin-top: 60px; }
        .btn-warning { background-color: #d4af37; border-color: #d4af37; color: #1a3a52; font-weight: 600; }
        .btn-warning:hover { background-color: #c9a227; border-color: #c9a227; color: #1a3a52; }
    </style>
</head>
<body>
    @include('navigation')
    ...
    <div class="hero-section">
        <div class="hero-content">
            <div class="container">
                <h1 class="display-5 fw-bold mb-3">{{ $profil->judul ?? 'Visi dan Misi PPID' }}</h1>
