...
<div class="space-y-8 animate-fade-in lg:px-8">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">Kelola dokumen Prosedur Operasional Standar Pengujian Konsekuensi Informasi Publik.</p>
                </div>
            </div>

            <div class="flex items-center gap-4">
                <a href="{{ route('prosedur.sop-pengujian') }}" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
    ...
    @include('admin.components.dokumen-list-admin', ['kategori' => 'SOP Pengujian Konsekuensi'])
</div>
@endsection
