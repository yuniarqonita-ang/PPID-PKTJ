...
<head>
    ...
    <title>{{ $peraturan->judul }} - Portal PPID PKTJ</title>
...
<body>
    ...
    <div id="pdf-container">
        @if($peraturan->file_path && pathinfo($peraturan->file_path, PATHINFO_EXTENSION) === 'pdf')
            <iframe src="{{ asset('storage/' . $peraturan->file_path) }}" allowfullscreen></iframe>
        @else
