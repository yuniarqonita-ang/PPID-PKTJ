    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h1 class="text-3xl font-black text-[#002b5c] tracking-tight">
                Manajemen <span class="text-[#004a99]">Berita</span>
            </h1>
            <p class="text-slate-500 text-sm font-medium mt-1">Publikasikan informasi terkini dan pengumuman resmi PPID</p>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.berita.create') }}" class="px-8 py-4 bg-[#ffc107] text-[#002b5c] font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl shadow-amber-500/20 hover:scale-105 active:scale-95 transition-all flex items-center border-none">
