    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden border-t-4 border-blue-500">
            <div class="p-6">
                ...
                <a href="{{ route('admin.profil.edit', 'profil') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded text-sm transition">
                    Edit
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden border-t-4 border-yellow-500">
            <div class="p-6">
                ...
                <a href="{{ route('admin.profil.edit', 'tugas') }}" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded text-sm transition">
                    Edit
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden border-t-4 border-green-500">
            <div class="p-6">
                ...
                <a href="{{ route('admin.profil.edit', 'visi') }}" class="inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded text-sm transition">
                    Edit
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden border-t-4 border-red-500">
            <div class="p-6">
                ...
                <a href="{{ route('admin.profil.edit', 'struktur') }}" class="inline-block bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded text-sm transition">
                    Edit
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden border-t-4 border-purple-500">
            <div class="p-6">
                ...
                <a href="{{ route('admin.profil.edit', 'regulasi') }}" class="inline-block bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded text-sm transition">
                    Edit
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden border-t-4 border-cyan-500">
            <div class="p-6">
                ...
                <a href="{{ route('admin.profil.edit', 'kontak') }}" class="inline-block bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded text-sm transition">
                    Edit
                </a>
            </div>
        </div>
