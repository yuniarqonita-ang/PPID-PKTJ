...
<body>
    ...
    <div class="hero-section">
        <div class="container hero-content">
            <h1 class="display-4 fw-bold outfit uppercase mb-2">{{ $settings['laporan_survey_judul_hero'] ?? 'Statistik Kepuasan' }}</h1>
            <p class="lead opacity-75">{{ $settings['laporan_survey_tagline_hero'] ?? 'Hasil Survey Kepuasan Masyarakat' }}</p>
        </div>
    </div>

    <div class="container mb-5">
        <div class="content-card">
            <h2 class="section-title">{{ $settings['laporan_survey_judul_hero'] ?? 'Laporan Survey Kepuasan Masyarakat' }}</h2>
