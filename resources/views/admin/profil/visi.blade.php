        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative group">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
                    <h1 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-lg">✨ Edit Visi & Misi PPID</h1>
                </div>
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('admin.visi.update', 1) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-slate-300 font-bold mb-2">Visi PPID</label>
                            <textarea name="visi" rows="4" class="w-full px-4 py-3 border-2 border-slate-600/50 text-white placeholder-slate-500 rounded-xl focus:border-cyan-400 focus:ring-1 focus:ring-cyan-500/50 focus:outline-none transition-all duration-300 shadow-inner bg-slate-900/60 border-slate-600/50 text-white placeholder-slate-400 shadow-inner focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-400" required></textarea>
                        </div>

                        <div>
                            <label class="block text-slate-300 font-bold mb-2">Misi PPID</label>
                            <textarea id="editor" name="misi" rows="8" class="w-full px-4 py-3 border-2 border-slate-600/50 text-white placeholder-slate-500 rounded-xl focus:border-cyan-400 focus:ring-1 focus:ring-cyan-500/50 focus:outline-none transition-all duration-300 shadow-inner bg-slate-900/60 border-slate-600/50 text-white placeholder-slate-400 shadow-inner focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-400"></textarea>
                        </div>
