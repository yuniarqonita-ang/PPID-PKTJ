                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors group {{ (!$item->file_path && !$hasLinks) ? 'bg-red-50/30' : '' }}" data-link-type="{{ $linkType }}">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.informasi.berkala.edit', $item->id) }}" class="p-2 bg-blue-50 text-[#004a99] rounded-lg hover:bg-[#004a99] hover:text-white transition-all shadow-sm" title="Edit Informasi">
                                        <i class="fas fa-edit"></i>
                                    </a>
