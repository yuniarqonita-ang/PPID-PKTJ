...
<div class="table-responsive my-3">
    <table class="table table-bordered table-striped table-hover align-middle mb-0" style="font-size: 13.5px; border-color: #cbd5e1;">
        ...
        return '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8"><title>Deploy & Sinkronisasi Selesai</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"></head><body class="bg-light d-flex align-items-center justify-content-center min-vh-100 py-5"><div class="card shadow-lg p-5 rounded-4 text-center" style="max-width: 680px;"><div class="display-4 text-success mb-3"><i class="fas fa-check-circle"></i></div><h3 class="fw-bold text-dark mb-2">Sinkronisasi & Pembersihan Berhasil!</h3><p class="text-muted small mb-4">Seluruh data zonk/kosong telah dihapus permanen. 50 Dokumen resmi 2026 ber-link Google Drive aktif telah ditayangkan secara rapi di semua submenu Informasi Publik.</p><div class="p-3 bg-light border rounded-3 text-start small mb-4"><ul class="mb-0 ps-3"><li><strong>Informasi Berkala:</strong> 20 dokumen resmi tayang aktif</li><li><strong>Informasi Serta Merta:</strong> 11 dokumen resmi tayang aktif</li><li><strong>Informasi Setiap Saat:</strong> 19 dokumen resmi tayang aktif</li><li><strong>Laporan Layanan:</strong> Data duplikat/kosong dibersihkan tuntas</li><li><strong>Profil Pejabat:</strong> Menu sidebar dirapikan & edit tanpa error</li></ul></div><div class="d-grid gap-2"><a href="/Rekapitulasi_Link_Terverifikasi_dan_Tayang_Publik_2026.xlsx" class="btn btn-success fw-bold py-2.5 rounded-pill"><i class="fas fa-file-excel me-2"></i> Unduh File Rekapitulasi Excel 2026</a><a href="/informasi-publik/berkala" class="btn btn-primary fw-bold py-2.5 rounded-pill"><i class="fas fa-table me-2"></i> Buka Halaman Informasi Berkala</a><a href="/informasi-publik/serta-merta" class="btn btn-outline-primary fw-bold py-2.5 rounded-pill"><i class="fas fa-bullhorn me-2"></i> Buka Halaman Informasi Serta Merta</a><a href="/informasi-publik/setiap-saat" class="btn btn-outline-primary fw-bold py-2.5 rounded-pill"><i class="fas fa-folder me-2"></i> Buka Halaman Informasi Setiap Saat</a><a href="/admin/pejabat" class="btn btn-dark fw-bold py-2.5 rounded-pill"><i class="fas fa-user-tie me-2"></i> Panel Admin: Profil Pejabat</a></div></div></body></html>';
    } catch (\Throwable $e) {
