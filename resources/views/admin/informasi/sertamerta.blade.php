                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="group">
                        ...
                        <div class="bg-white rounded-xl border-2 border-slate-200 shadow-inner">
                            <textarea id="editor_sertamerta_index" name="konten" class="w-full p-6 border-0 outline-none resize-none" style="min-height: 300px;">
                            ...
                            <label class="relative cursor-pointer">
                                ...
                                <div class="p-4 border-2 border-slate-200 rounded-xl hover:border-blue-400 peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all">
                                    <div class="text-center">
                                        ...
                                        <p class="font-medium text-slate-700 peer-checked:text-blue-700">Normal</p>
                                        <p class="text-xs text-slate-500">1-24 jam</p>
                                    </div>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                ...
                                <div class="p-4 border-2 border-slate-200 rounded-xl hover:border-purple-400 peer-checked:border-purple-500 peer-checked:bg-purple-50 transition-all">
                                    <div class="text-center">
                                        ...
                                        <p class="font-medium text-slate-700 peer-checked:text-purple-700">Segera</p>
                                        <p class="text-xs text-slate-500">1-6 jam</p>
                                    </div>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                ...
                                <div class="p-4 border-2 border-slate-200 rounded-xl hover:border-indigo-400 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all">
                                    <div class="text-center">
                                        ...
                                        <p class="font-medium text-slate-700 peer-checked:text-indigo-700">Darurat</p>
                                        <p class="text-xs text-slate-500">Langsung</p>
                                    </div>
                                </div>
                            </label>
                        </div>
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-orange-700">Singkat, jelas, dan mendesak</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <span class="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></span>
                                ...
                                <div class="flex items-start space-x-2">
                                    <span class="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></span>
                                    <div>
                                        <strong class="text-orange-800">Tingkat:</strong>
                                        <p class="text-orange-700">Pilih tingkat kesegeraan</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <span class="w-1.5 h-1.5 bg-orange-500 rounded-full mt-1.5 flex-shrink-0"></span>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 p-6 shadow-lg">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-bold text-blue-800">Tentang Informasi Serta Merta</h3>
                            </div>
