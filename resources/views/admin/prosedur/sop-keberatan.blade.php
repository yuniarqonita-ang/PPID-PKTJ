...
<div class="space-y-8 animate-fade-in lg:px-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <h1 class="text-3xl md:text-5xl font-black tracking-tight leading-tight text-white mb-2">
                        SOP <span class="text-[#ffc107]">Penanganan Keberatan</span>
                    </h1>
                    <p class="text-blue-50 text-lg font-bold max-w-2xl opacity-90">Kelola dokumen Prosedur Operasional Standar Penanganan Keberatan Informasi Publik.</p>
                </div>
            </div>

            <div class="flex items-center gap-4">
                <a href="{{ route('prosedur.sop-keberatan') }}" target="_blank" class="px-6 py-4 bg-white/10 border border-white/20 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-white/20 transition-all flex items-center">
    ...
    @include('admin.components.dokumen-list-admin', ['kategori' => 'SOP Penanganan Keberatan'])
</div>
@endsection
