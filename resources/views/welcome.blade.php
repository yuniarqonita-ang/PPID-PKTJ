        ...
        <div class="row pt-4">
            ...
            <div class="col-md-4 mb-5">
                ...
                <div class="list-group card p-0">
                    ...
                    <a href="{{ route('admin.lpse.index') }}" class="list-group-item list-group-item-action py-3 px-3">
                        <i class="fas fa-link me-2" style="color: #d4af37;"></i>LPSE PKTJ
                    </a>
                    <a href="{{ route('admin.jdih.index') }}" class="list-group-item list-group-item-action py-3 px-3">
